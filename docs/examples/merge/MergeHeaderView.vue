...
const columns: Column[] = [
    ...
    children: [
      {
        ...
        children: [
          ...
          { field: 'key2-1-2', title: 'key2-1-2', type: CellType.Text, width: 200 },
        ],
      },
      {
        field: 'key2-2',
  ...
  },
  {
    ...
    // fixed: 'right',
    children: [
      { field: 'key11-1', title: 'title12', type: CellType.Text, width: 200 },
      { field: 'key12-1', title: 'title12', type: CellType.Text, width: 200 },
    ],
  },
];
const list: ListItem[] = [];
